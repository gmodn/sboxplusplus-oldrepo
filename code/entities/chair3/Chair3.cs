...
public partial class Chair3Entity : Prop, IUse
{
	...
	public bool OnUse( Entity user )
	{
		...
		{
			player.Vehicle = this;
			player.VehicleController = new Chair3Controller();
			player.VehicleAnimator = new Chair3Animator();
			player.VehicleCamera = new Chair3Camera();
			player.Parent = this;
